...
## Remarques :
Cette application sera refaite avec Angular pour le front et Spring pour le back. Aussi, le code n'a pas été refactorisé depuis 2017 (du code en mauvais état pour l'instant). Donc, cette version de l'application va changer dans les jours, mois à venir. 
