        ...
        <% 
                ...
                try
                {
                    ...
                    {               //dans le channel TI ou L3
                            ...
                            {
                                if(unMessage.getContenue().indexOf("youtube.com/watch?v=")!=-1)
                                {
                                    String idVideo = unMessage.getContenue().split("v=")[1];
                ...
                {   //dans une conversation privée
                    ...
                    int nbMessagesSortant = listMessagesSortant.size();
                        ...
                        while (it.hasNext()){
                            ...
                            if(valeur.getContenue().indexOf("youtube.com/watch?v=")!=-1)
                            {
                                    String idVideo = valeur.getContenue().split("v=")[1];
                                    if(idVideo.indexOf("&")!=-1){
                                        idVideo = idVideo.split("&")[0];  
                                    }
